...
export const specGroups = [
  { title: "Kích thước & không gian", items: [["Kích thước", "dimensions"], ["Chiều dài cơ sở", "wheelbase"], ["Khoảng sáng gầm", "clearance"], ["Khoang hành lý", "trunk"], ["Kích thước khoang hàng", "cargoDimensions"], ["Bán kính quay vòng", "turningRadius"], ["Đường kính quay đầu tối thiểu", "turningDiameter"], ["Tải trọng hành lý nóc", "roofLoad"], ["Khối lượng không tải", "curbWeight"], ["Tải trọng", "payload"], ["Số chỗ", "seats"]] },
  { title: "Pin & vận hành", items: [["Quãng đường", "range"], ["Dung lượng pin", "battery"], ["Công suất", "power"], ["Mô-men xoắn", "torque"], ["Tốc độ tối đa", "topSpeed"], ["Tăng tốc", "acceleration"], ["Khả năng lội nước", "wadingDepth"], ["Chế độ lái", "driveModes"], ["Hệ dẫn động", "drivetrain"], ["Phanh tái sinh", "regenerativeBraking"], ["Sạc nhanh DC", "dcCharge"], ["Sạc AC tối đa", "acCharge"]] },
  ...
  { title: "Nội thất & tiện nghi", items: [["Chất liệu ghế", "upholstery"], ["Ghế & vô-lăng", "seatFeatures"], ["Điều hòa & lọc khí", "climate"], ["Màn hình", "screen"], ["Âm thanh", "speakers"], ["Kết nối", "connectivity"], ["Tiện nghi khác", "convenience"], ["Tính năng thông minh", "smartFeatures"]] },
  { title: "An toàn & hỗ trợ lái", items: [["Túi khí", "airbags"], ["An toàn chủ động", "safetySystems"], ["Hỗ trợ đỗ xe", "parkingSupport"], ["ADAS", "adas"]] },
  { title: "Bảo hành", items: [["Bảo hành xe", "vehicleWarranty"], ["Bảo hành pin cao áp", "batteryWarranty"], ["Điều kiện bảo hành", "warrantyConditions"]] }
];
