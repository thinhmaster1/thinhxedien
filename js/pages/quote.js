...
Promise.all([loadCars(), fetch("data/promotions.json").then(response => {
  ...
  function calculate() {
    ...
    const registrationService = Number(form.elements.registrationService.value) || 0;
